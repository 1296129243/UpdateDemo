...
public class MainActivity extends AppCompatActivity {
    ...
    // 下载存储的文件名
    private static final String DOWNLOAD_NAME = "AI-tech.apk";
    ...
    private void getVersion(final int vision) {
        ...
        http.send(HttpRequest.HttpMethod.GET, url, new RequestCallBack<String>() {
            //{"code": 10000, "data":[ "1.0", "http://120.78.152.106/prog/vceApk"]}
            @Override
            public void onSuccess(ResponseInfo<String> responseInfo) {
                ...
                if (result != null) {
                    ...
                    try {
                        ...
                        String newversion = (String) data1.get(0);//服务器软件版本
                        String versionURL = (String) data1.get(1);//服务器软件下载地址
                        double newversioncode = Double
                                .parseDouble(newversion);
                        int cc = (int) (newversioncode);
                        String content = "最新版本号:" + newversion;
                        System.out.println(newversion + "v" + vision + ","
                                + cc);// 8.0   v  1 , 8
                        Log.e(TAG,"版本号：" + cc + " === " + vision );
                        //判断当前版本号与服务器版本号的大小
                        if (cc != vision) {
                            if (vision < cc) {
                                System.out.println(newversion + "v" + vision);
                                // 版本号不同
                                ShowDialog(vision, newversion, content, versionURL);
                            }
                        }
